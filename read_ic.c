...
void empty_read_buffer(enum iofields blocknr, int offset, int pc, int type)
{
    ...
    switch (blocknr)
    {
        ...
        case IO_PHone:
            ...
            for(n = 0; n < pc; n++)
                SphP[offset + n].Primordial_Chem[0] = *fp++;
#endif
            break;
...
#ifdef PRIMORDIAL_COOLING
            for(n = 0; n < pc; n++)
                SphP[offset + n].Primordial_Chem[1] = *fp++;
#endif
            break;
...
#ifdef PRIMORDIAL_COOLING
            for(n = 0; n < pc; n++)
                SphP[offset + n].Primordial_Chem[3] = *fp++;
#endif
            break;
...
#ifdef PRIMORDIAL_COOLING
            for(n = 0; n < pc; n++)
                SphP[offset + n].Primordial_Chem[11] = *fp++;
#endif
            break;
...
#ifdef PRIMORDIAL_COOLING
            for(n = 0; n < pc; n++)
                SphP[offset + n].Primordial_Chem[5] = *fp++;
#endif
            break;
...
#ifdef LYMAN_WERNER
            for(n = 0; n < pc; n++)
                SphP[offset + n].Primordial_Chem[12] = *fp++;
#endif
            break;
...
#ifdef LYMAN_WERNER
            for(n = 0; n < pc; n++)
                SphP[offset + n].Primordial_Chem[13] = *fp++;
#endif
            break;
