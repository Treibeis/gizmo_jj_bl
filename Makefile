...
FFTW2_HOME  = $(HOME)/local/fftw
FFTW_INCL   = -I$(FFTW2_HOME)/include
FFTW_LIBS   = -L$(FFTW2_HOME)/lib
HDF5LIB     = -lhdf5
MPICHLIB    = #
GRACKLELIBS = -L$(HOME)/local/lib -lgrackle
GRACKLEINCL = -I$(HOME)/local/include
...
ifeq ($(SYSTYPE),"ELGATO-GNU")
CC   = mpicc
CXX  = mpicxx
FC   = $(CC)
OPT += -DH5_USE_16_API
GSL_LIBS    = -L/home/u19/rthompson/local/gsl/lib
GSL_INCL    = -I/home/u19/rthompson/local/gsl/include
FFTW_INCL   = -I/home/u19/rthompson/local/fftw/include
FFTW_LIBS   = -L/home/u19/rthompson/local/fftw/lib
HDF5LIB     = -L/home/u19/rthompson/local/hdf5/lib -lhdf5
HDF5INCL    = -I/home/u19/rthompson/local/hdf5/include
GRACKLEINCL = -I/home/u19/rthompson/local/grackle_gnu/include
GRACKLELIBS = -L/home/u19/rthompson/local/grackle_gnu/lib -lgrackle
...
ifeq ($(SYSTYPE),"ELGATO-INTEL")
CC   = mpiicc
CXX  = mpiicpc
FC   = $(CC)
OPT += -DH5_USE_16_API
GSL_LIBS    = -L/uaopt/gsl/1.16/lib
GSL_INCL    = -I/uaopt/gsl/1.16/include
FFTW_INCL   = -I/uaopt/fftw/2.1.5/include
FFTW_LIBS   = -L/uaopt/fftw/2.1.5/lib
HDF5LIB     = -L/home/u19/rthompson/local/hdf5/lib -lhdf5
HDF5INCL    = -I/home/u19/rthompson/local/hdf5/include
GRACKLEINCL = -I/home/u19/rthompson/local/grackle_intel/include
GRACKLELIBS = -L/home/u19/rthompson/local/grackle_intel/lib -lgrackle
OPTIMIZE   += -O3 -xavx -ip -funroll-loops
ifeq (OPENMP,$(findstring OPENMP,$(CONFIGVARS)))
OPTIMIZE   += -fopenmp  # openmp required compiler flags
endif
endif

ifeq ($(SYSTYPE),"TIMON-PUMBAA_GNU")
CC   = mpicc
CXX  = mpicxx
FC   = $(CC)
OPT += -DH5_USE_16_API
GSL_INCL    = -I/opt/gsl-1.16/include
GSL_LIBS    = -L/opt/gsl-1.16/lib -lgsl -lgslcblas
FFTW_INCL   = -I/opt/fftw-2.1.5/include
FFTW_LIBS   = -L/opt/fftw-2.1.5/lib
HDF5INCL    = -I/opt/hdf5-1.8.13/include
HDF5LIB     = -L/opt/hdf5-1.8.13/lib -lhdf5
MPICHLIB    = -lmpi
GRACKLEINCL = -I/home/rad/gizmo-extra/grackle/include
GRACKLELIBS = -L/home/rad/gizmo-extra/grackle/lib -lgrackle
OPTIMIZE   += -O2 -funroll-loops
ifeq (OPENMP,$(findstring OPENMP,$(CONFIGVARS)))
OPTIMIZE   += -fopenmp  # openmp required compiler flags
endif
...
ifeq ($(SYSTYPE),"TIMON-PUMBAA_OPEN64")
CC   = /home/rad/open64/openmpi-1.8.5/bin/mpicc
CXX  = /home/rad/open64/openmpi-1.8.5/bin/mpicxx
FC   = $(CC)
OPT += -DH5_USE_16_API
GSL_INCL    = -I/home/rad/open64/gsl-1.16/include
GSL_LIBS    = -L/home/rad/open64/gsl-1.16/lib -lgsl -lgslcblas
FFTW_INCL   = -I/home/rad/open64/fftw-2.1.5/include
FFTW_LIBS   = -L/home/rad/open64/fftw-2.1.5/lib
HDF5INCL    = -I/opt/hdf5-1.8.13_open64/include
HDF5LIB     = -L/opt/hdf5-1.8.13_open64/lib -lhdf5
MPICHLIB    = -lmpi
#GRACKLEINCL = -I/home/rad/open64/grackle/include
#GRACKLELIBS = -L/home/rad/open64/grackle/lib -lgrackle
GRACKLEINCL = -I/home/rad/gizmo-extra/grackle/include
GRACKLELIBS = -L/home/rad/gizmo-extra/grackle/lib -lgrackle
OPTIMIZE   += -O3 -mso -march=barcelona -funroll-loops
ifeq (OPENMP,$(findstring OPENMP,$(CONFIGVARS)))
OPTIMIZE   += -fopenmp  # openmp required compiler flags
endif
endif

ifeq ($(SYSTYPE),"ursa-gcc")
CC   =  mpicc
CXX  =  mpicxx
FC   =  $(CC)
OPT += -DH5_USE_16_API -DCONFIG_BFLOAT_8
...
FFTW_INCL = -I/home/rad/gadget-3.25utils/fftw/gcc/fftw-2.1.5/include
FFTW_LIBS = -L/home/rad/gadget-3.25utils/fftw/gcc/fftw-2.1.5/lib
#MPICHLIB  = -L/home/rad/gadget-3.25utils/openmpi/open64/openmpi-1.6.5/lib
GRACKLEINCL = -I/home/rad/gizmo/grackle/src/clib/include
GRACKLELIBS = -L/home/rad/gizmo/grackle/src/clib/lib -lgrackle
HDF5INCL  = 
HDF5LIB   = -lhdf5 
endif

ifeq ($(SYSTYPE),"ursa-open64")
CC   =  /home/rad/gadget-3.25utils/openmpi/open64/openmpi-1.6.5/bin/mpicc
CXX  =  /home/rad/gadget-3.25utils/openmpi/open64/openmpi-1.6.5/bin/mpicxxFC      =  $(CC)
OPT += -DH5_USE_16_API -DCONFIG_BFLOAT_8
OPTIMIZE += -Ofast -march=auto
ifeq (OPENMP,$(findstring OPENMP,$(CONFIGVARS)))
OPTIMIZE += -fopenmp  # openmp required compiler flags
endif
FFTW_INCL = -I/home/rad/gadget-3.25utils/fftw/open64/fftw-2.1.5/include
FFTW_LIBS = -L/home/rad/gadget-3.25utils/fftw/open64/fftw-2.1.5/libMPICHLIB = -L/home/rad/gadget-3.25utils/openmpi/open64/openmpi-1.6.5/lib
HDF5INCL  = HDF5LIB  = -lhdf5
endif
...
CXX      =  mpiCC
FC       =  $(CC)
OPTIMIZE = -O2 -xhost -ipo -funroll-loops -no-prec-div -fp-model fast=2  # speed
...
GSL_LIBS =  -L/usr/lib/x86_64-linux-gnu #-Wl,"-R /usr/common/pdsoft/lib"
FFTW_INCL=  -I/usr/local/include
FFTW_LIBS=  -L/usr/local/lib#/x86_64-linux-gnu
MPICHLIB =  -L/usr/lib/x86_64-linux-gnu
HDF5INCL = -I/usr/local/hdf5/include -DH5_USE_16_API
HDF5LIB  = -L/usr/local/hdf5/lib -lhdf5 -lz
endif

ifeq ($(SYSTYPE),"Stampede_test") # checks if we are in Stampede according to the Makefile.systype file  
...
GSL_LIBS = -L$(TACC_GSL_LIB)
#FFTW_INCL= -I$(TACC_FFTW2_INC)
FFTW_INCL= -I/home1/01433/jaacksj/local/include #-I$HOME/local/include
#FFTW_LIBS= -L$(TACC_FFTW2_LIB)
FFTW_LIBS= -L/home1/01433/jaacksj/local/include #-L$HOME/local/lib
HDF5INCL = -I$(TACC_HDF5_INC) -DH5_USE_16_API
HDF5LIB  = -L$(TACC_HDF5_LIB) -lhdf5 -lz
#MPICHLIB =
OPT     += -DUSE_MPI_IN_PLACE
...
##    RT & JJ       ##
######################
ifeq (POPIII,$(findstring POPIII,$(CONFIGVARS)))
OBJS	+= galaxy_sf/popIII.o
endif

ifeq (POPII_P2L,$(findstring POPII_P2L,$(CONFIGVARS)))
OBJS	+= galaxy_sf/popII.o
endif
