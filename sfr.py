...
if __name__ == "__main__":
	...
	plt.text(8,1e-6,r'$V_{Z,c}\simeq 11\ \mathrm{Mpc^{3}}$')
	plt.ylim(down1, up1)
	plt.xlabel(r'$z$')
	...
	plt.text(7.3,1e2,r'$V_{Z,c}\simeq 11\ \mathrm{Mpc^{3}}$')
	plt.xlabel(r'$z$')
	plt.ylabel(r'$\rho_{*}\ [M_{\odot}\ \mathrm{Mpc^{-3}}]$')
	plt.ylim(down2, up2)
	if sca>0:
		plt.yscale('log')
	plt.legend()
