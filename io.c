...
void fill_write_buffer(enum iofields blocknr, int *startindex, int pc, int type)
{
    ...
    case IO_PHone:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = SphP[pindex].Primordial_Chem[0];
      n++;
    }
      }
#endif
    ...
    case IO_PHII:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = SphP[pindex].Primordial_Chem[1];
      n++;
    }
      }
#endif
    ...
    case IO_PH2:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = SphP[pindex].Primordial_Chem[3];
      n++;
    }
      }
#endif
    ...
    case IO_PHD:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = SphP[pindex].Primordial_Chem[11];
      n++;
    }
      }
#endif
    ...
    case IO_Pe:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = SphP[pindex].Primordial_Chem[5];
      n++;
    }
      }
#endif
    ...
    case IO_fshield:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = SphP[pindex].Primordial_Chem[12];
      n++;
    }
      }
#endif
    ...
    case IO_JLW:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = SphP[pindex].Primordial_Chem[13];
      n++;
    }
      }
#endif
    ...
    case IO_LCHAR:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = evaluate_dL_from_GradRho(P[pindex].GradRho,PPP[pindex].Hsml,SphP[pindex].Density,PPP[pindex].NumNgb,0);
      n++;
    }
      }
#endif
    ...
    case IO_NHI:
      ...
      for(n = 0; n < pc; pindex++){
    if(P[pindex].Type == type){
      *fp++ = evaluate_NH_from_GradRho(P[pindex].GradRho,PPP[pindex].Hsml,SphP[pindex].Density,PPP[pindex].NumNgb,1);
      n++;
    }
      }
#endif
	...
	if(P[pindex].Type == type)
	  {
	    *ip_int++ = SphP[pindex].N_windLaunches;
	    n++;
	  }
#endif
      break;
...
void get_Tab_IO_Label(enum iofields blocknr, char *label)
{
    switch (blocknr)
    {
	    ...
	    break;
        case IO_SIGMA:
	       strncpy(label, "Sigm", 4);
	        break;
        case IO_PHone:
            strncpy(label, "PHon", 4);
         break;
        case IO_PHII:
            strncpy(label, "PHII", 4);
            break;
        case IO_PH2:
            strncpy(label, "PH2 ", 4);
            break;
        ...
        case IO_Pe:
            ...
            break;
        case IO_fshield:
            strncpy(label, "fshd", 4);
            break;
        case IO_JLW:
            strncpy(label, "JLW ", 4);
            break;
        case IO_LCHAR:
            strncpy(label, "Lchr", 4);
            break;
        case IO_NHI:
            strncpy(label, "NHI ", 4);
            break;
        case IO_STARTYPE:
            strncpy(label, "STYP", 4);
            break;
        case IO_NWINDLAUNCHES:
            strncpy(label, "NWL ", 4);
	    break;
...
void get_dataset_name(enum iofields blocknr, char *buf)
{
    ...
    switch (blocknr)
    {
	    ...
	    break;
        case IO_PHone:
        strcpy(buf, "Primordial HI");
        break;
        case IO_PHII:
        strcpy(buf, "Primordial HII");
        break; 
        case IO_PH2:
        strcpy(buf, "Primordial H2");
        break; 
        case IO_PHD:
        strcpy(buf, "Primordial HD");
        break; 
        case IO_Pe:
        strcpy(buf, "Primordial e-");
        break;
        case IO_fshield:
        strcpy(buf, "fH2 shield");
        break; 
        case IO_JLW:
        strcpy(buf, "J_LW");
        break;
